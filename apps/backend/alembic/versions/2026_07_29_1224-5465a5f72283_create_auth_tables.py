...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("account_status", sa.String(length=50), nullable=False, server_default="Pending"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["identity_id"], ["identities.id"], name=op.f("fk_users_identity_id_identities")),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.Column("updated_at", sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.ForeignKeyConstraint(["identity_id"], ["identities.id"], name=op.f("fk_sessions_identity_id_identities")),
